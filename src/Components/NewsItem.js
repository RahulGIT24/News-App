    ...
    <div className='container'>
      <div className={`card bg-${props.mode === 'light' ? 'light' : 'dark'} text-${props.mode === 'light' ? 'dark' : 'light'}`} >
        ...
        <div className="card-body">
          ...
          <a href={props.newsUrl} target="_blank" rel='noreferrer' className={`btn btn-sm btn-${props.mode === 'light' ? 'dark' : 'light'} bg-${props.mode === 'light' ? 'light' : 'dark'} text-${props.mode === 'light' ? 'dark' : 'light'}`}>Read More</a>
        </div>
      </div>
    </div>
  )
